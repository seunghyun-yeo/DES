...
public class Feistel {
	...
	public int dofeistel(int input, long key)
	{
		...
		long after_expansion = Long.parseUnsignedLong(afterexpansion_str,2);
		long after_xor = (long)((long)(after_expansion ^ key)&0xffff_ffff_ffffL);
		String after_xor_str =String.format("%48s",Long.toBinaryString(after_xor)).replace(' ','0');
		//System.out.println(String.format("%48s",Long.toBinaryString(after_xor)).replace(' ','0'));
